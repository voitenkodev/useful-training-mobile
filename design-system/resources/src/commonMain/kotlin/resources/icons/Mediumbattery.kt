...
internal val MediumBattery: ImageVector
    get() {
        if (_Mediumbattery != null) {
            return _Mediumbattery!!
        }
        _Mediumbattery = ImageVector.Builder(
            name = "Mediumbattery",
            defaultWidth = 100.dp,
...
private var _Mediumbattery: ImageVector? = null
